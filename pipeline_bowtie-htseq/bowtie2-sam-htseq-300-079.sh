...
bowtie2 -t -I 150 -X 350 --no-discordant -p 4 -1 002736_079-1-3_AGTTCC_R1_filtered.fastq -2 002736_079-1-3_AGTTCC_R2_filtered.fastq purpurea -S 079-1-3.sam

export LC_ALL=POSIX
sort -s -k 1,1 079-1-3.sam > 079-1-3-sorted.sam
perl sam_readname_trim.pl 079-1-3-sorted.sam

sed '/XS:/d' 079-1-3-sorted.sam.trimmed.sam > 079-1-3-sorted.sam.trimmed.sam.uniquealn.sam

htseq-count -t mRNA -s no 079-1-3-sorted.sam.trimmed.sam.uniquealn.sam purpurea.gff > 079-1-3.count

cp 079-1-3-sorted.sam.trimmed.sam.uniquealn.sam /nfs/09/ucn1113/bowtie2_output/trimmed_300_ref/
