...
sed '/XS:/d' 068-1-1-sorted.sam.trimmed.sam > 068-1-1-sorted.sam.trimmed.sam.uniquealn.sam

htseq-count -t mRNA -s no 068-1-1-sorted.sam.trimmed.sam.uniquealn.sam purpurea.gff > 068-1-1.count

cp 068-1-1-sorted.sam.trimmed.sam.uniquealn.sam /nfs/09/ucn1113/bowtie2_output/trimmed_300_ref/
cp 068-1-1.count /nfs/09/ucn1113/bowtie2_output/trimmed_300_ref/
