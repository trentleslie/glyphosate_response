...
bowtie2 -t -I 150 -X 350 --no-discordant -p 4 -1 002737_336-1-2_ATGTCA_R1_filtered.fastq -2 002737_336-1-2_ATGTCA_R2_filtered.fastq purpurea -S 336-1-2.sam

export LC_ALL=POSIX
sort -s -k 1,1 336-1-2.sam > 336-1-2-sorted.sam
perl sam_readname_trim.pl 336-1-2-sorted.sam

sed '/XS:/d' 336-1-2-sorted.sam.trimmed.sam > 336-1-2-sorted.sam.trimmed.sam.uniquealn.sam

htseq-count -t mRNA -s no 336-1-2-sorted.sam.trimmed.sam.uniquealn.sam purpurea.gff > 336-1-2.count

cp 336-1-2-sorted.sam.trimmed.sam.uniquealn.sam /nfs/09/ucn1113/bowtie2_output/trimmed_300_ref/
cp 336-1-2.count /nfs/09/ucn1113/bowtie2_output/trimmed_300_ref/
